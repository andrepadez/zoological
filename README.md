...
Templating engine for css based on width and height of the window, as a Connect/Express Middleware.
This module was made to serve a very specific necessity. As I dwelve into mobile apps development, I felt the need to have custom CSS served depending on the dimensions of the client window; i know there's probably an easier way to do this but i'm not very good with CSS.
This is a very early version, but it works; and i have some neat features in development stage. I will be updating this repo and documentation frequently until i reach version 1.0 (checkout the roadmap).
